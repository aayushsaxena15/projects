...
//    cout << "asdfasdf\n";
file1.getRecord("bicycle_report",0);
file1.getRecord("bicycle_report",1);
file1.getRecord("bicycle_report",2);
file1.insertRecord("bicycle_report", "record");
file1.getRecord("bicycle_report",2);
file1.getRecord("bicycle_report",2);
file1.getRecord("bicycle_report",3);
file1.getRecord("bicycle_report",41);
file1.getRecord("bicycle_report",9);
file1.getRecord("bicycle_report",39);
file1.getRecord("bicycle_report",28);
file1.getRecord("bicycle_report",1);
file1.getRecord("bicycle_report",30);
file1.getRecord("bicycle_report",38);
file1.getRecord("bicycle_report",39);
file1.getRecord("bicycle_report",50);
file1.insertRecord("bicycle_report", "record");
file1.insertRecord("bicycle_report", "record");
file1.getRecord("bicycle_report",300);
file1.getRecord("bicycle_report",450);
file1.insertRecord("bicycle_report", "record");
file1.getRecord("bicycle_report",134);
file1.getRecord("bicycle_report",400);
file1.getRecord("bicycle_report",90);
file1.insertRecord("bicycle_report", "record");
file1.getRecord("bicycle_report",850);
file1.insertRecord("bicycle_report", "record");
file1.getRecord("bicycle_report",700);
file1.getRecord("bicycle_report",650);
file1.getRecord("bicycle_report",600);
file1.getRecord("bicycle_report",500);
file1.insertRecord("bicycle_report", "record");
file1.getRecord("bicycle_report",579);
file1.getRecord("bicycle_report",590);
file1.getRecord("bicycle_report",592);
file1.getRecord("bicycle_report",595);
file1.insertRecord("bicycle_report", "record");
file1.getRecord("bicycle_report",900);
file1.insertRecord("bicycle_report", "record");
file1.getRecord("bicycle_report",123);
file1.insertRecord("bicycle_report", "record");
file1.getRecord("bicycle_report",31);
file1.insertRecord("bicycle_report", "record");
file1.getRecord("bicycle_report",42);
file1.getRecord("bicycle_report",28);

    //   int unique_entries=file1.V("table1","e_num");
    //    cout<<"Number of unique values= "<<unique_entries<<endl;
    //    file1.insertRecord("table1","sadsad,sadsd,sas");
    //   unique_entries=file1.V("table1","e_num");
    //   file1.flushPages();
    //   cout<<"Number of unique values= "<<unique_entries<<endl;
    //   file1.queryType("select table1.e_num from table1.csv join table1 on table1.abc=table1.def join t2 on table2.asd=table1.wer join t3 on table2.abc=table2.def");
...
//    file1.queryType("select s_id,s_order,s_num from table2 where table2.s_num<230 and table2.s_num>205 or table2.s_idLIKE48 groupby s_id having table2.s_order=50 orderby table2.s_num(DESC) ");
